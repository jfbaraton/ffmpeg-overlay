...
-rtbufsize 32M -i rtsp://minibun:aquarium@192.168.100.182/stream1 ^
-filter_complex "[1:v]pad=iw+8:ih+8:4:4:black[a]; [2:v]pad=iw+8:ih+8:4:4:black[b]; [0:v][a]overlay=30:(main_h/2)-(overlay_h/2)[c]; [c][b]overlay=main_w-overlay_w-30:(main_h/2)-(overlay_h/2)[video]; anullsrc=cl=mono:r=44100[audio]" ^
-map "[video]" -map "[audio]" ^
